var textContent = {
    ...
    faq: [{
            ...
            answer: "Praesent non sapien elementum, tempus nisl eget, eleifend nunc. Nulla aliquam augue urna, id varius metus convallis sit amet."
        },
        {
            question: "Lorem ipsum dolor sit amet, consectetur adipiscing elit?",
            answer: "Praesent non sapien elementum, tempus nisl eget, eleifend nunc. Nulla aliquam augue urna, id varius metus convallis sit amet."
        ...
        },
        {
            ...
            answer: "Don't hesitate to contact us directly! See our contact data down below."
        }
    ],
    contact: [{
            name: "Gabriel-Codrin Cojocaru",
            socialMedia: [{
                    link: "https://www.facebook.com/codrin.cojocaru.7",
                    src: "assets/img/facebook.png",
                    alt: "facebook-icon"
                },
                {
                    link: "https://twitter.com/gabrielxxzzz",
                    src: "assets/img/twitter.png",
                    alt: "twitter-icon"
                },
                {
                    link: "https://github.com/gabrielxzc",
                    src: "assets/img/github.svg",
                    alt: "github-icon"
                }
            ],
            photoClass: "contact__article__description--codrin",
            positioningClass: "contact__article__description--left",
        ...
        },
        {
            ...
            socialMedia: [{
                ...
                {
                    link: "https://github.com/alexmititelu",
                    src: "assets/img/github.svg",
                    alt: "github-icon"
                }
            ],
            photoClass: "contact__article__description--alex",
            positioningClass: "contact__article__description--right",
